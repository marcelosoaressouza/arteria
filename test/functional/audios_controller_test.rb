...
class AudiosControllerTest < ActionController::TestCase
  ...
  test "should create audio" do
    assert_difference('Audio.count') do
      post :create, audio: { description: @audio.description, published: @audio.published, slug: @audio.slug, title: @audio.title }
    end
  ...
  test "should update audio" do
    put :update, id: @audio, audio: { description: @audio.description, published: @audio.published, slug: @audio.slug, title: @audio.title }
    assert_redirected_to audio_path(assigns(:audio))
  end
